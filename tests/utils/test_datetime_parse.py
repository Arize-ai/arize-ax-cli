...
class TestParseOptionalIso8601:
    ...
    def test_date_only(self) -> None:
        """Date-only string parses to midnight UTC (naive assumed UTC)."""
    ...
    def test_datetime_with_t_separator(self) -> None:
        """Naive datetime is stamped UTC, keeping the clock time."""
    ...
    def test_explicit_offset_preserved(self) -> None:
        """An explicit offset is preserved, not re-stamped as UTC."""
        result = parse_optional_iso8601("2024-01-01T00:00:00+05:00")
        assert result.utcoffset() == timedelta(hours=5)
        # Same instant as 2023-12-31T19:00:00Z, never shifted.
        assert result == datetime(2023, 12, 31, 19, 0, 0, tzinfo=timezone.utc)
